...
public enum AuthErrorCode implements BaseErrorCode {
    ...
    USERNAME_ALREADY_EXISTS("AUTH003", "이미 사용중인 닉네임입니다.", HttpStatus.CONFLICT),
    INVALID_PASSWORD_FORMAT("AUTH004", "비밀번호 형식이 올바르지 않습니다. (영문 소문자 8~16자, 특수문자 !#$%&*@^ 포함)", HttpStatus.BAD_REQUEST),
    PASSWORD_MISMATCH("AUTH005", "비밀번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
